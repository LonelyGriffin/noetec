...
class InMemorySettingsService implements ISettingsService {
  ...
  @override
  Future<List<String>> getStringList(String key) async => (_store[key] as List<String>?) ?? [];

  @override
  Future<void> setStringList(String key, List<String> value) async => _store[key] = List<String>.from(value);
}
