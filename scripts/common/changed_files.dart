...
List<String> fetchStagedSourceFiles({
  List<String> prefixes = const ['lib/', 'scripts/'],
}) {
  ...
  final stagedFiles = (diffResult.stdout as String)
      ...
      .where((file) => prefixes.any((prefix) => file.startsWith(prefix)))
      .toList();

  return stagedFiles;
}

List<String> fetchChangedSourceFiles({
  List<String> prefixes = const ['lib/', 'scripts/'],
}) {
