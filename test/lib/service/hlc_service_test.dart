...
void main() {
  group('HlcService —', () {
    ...
    setUp(() {
      ...
      deviceService = vaultSystem.currentVault.value == null ? FakeDeviceService() : FakeDeviceService();
    ...
    void activateVault() {
      deviceService.setDevice(DeviceIdentity(uuid: 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee', name: 'Test', createdAt: DateTime(2026), lastHlc: null, publicKey: null));
    ...
    test('restores lastHlc from device stored key', () {
      deviceService.setDevice(
        DeviceIdentity(uuid: 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee', name: 'Test', createdAt: DateTime(2026), lastHlc: '1705312200000-0001-aabbccdd', publicKey: null),
      );
      vaultSystem.currentVault.value = VaultEntity(id: 'vault-1', name: 'TestVault', rootPath: '/vault', createdAt: DateTime(2026));
    ...
    test('ignores corrupt stored key', () {
      deviceService.setDevice(DeviceIdentity(uuid: 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee', name: 'Test', createdAt: DateTime(2026), lastHlc: 'corrupt-key', publicKey: null));
      vaultSystem.currentVault.value = VaultEntity(id: 'vault-1', name: 'TestVault', rootPath: '/vault', createdAt: DateTime(2026));
