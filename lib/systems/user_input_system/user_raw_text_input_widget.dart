...
class _UserRawTextInputWidgetState extends State<UserRawTextInputWidget>
  ...
  void updateEditingValueWithDeltas(List<TextEditingDelta> textEditingDeltas) {
    _inputService.handleTextDeltas(widget.pageId, textEditingDeltas);
  }
  ...
  void _openInputConnection() {
    if (_textInputConnection == null || !_textInputConnection!.attached) {
      ...
      final value = _inputService.getImeState(widget.pageId).value;
  ...
  KeyEventResult _handleKeyEvent(FocusNode node, KeyEvent event) {
    if (event is KeyDownEvent) {
      _inputService.handleKeyEvent(widget.pageId, event);
      return KeyEventResult.handled;
    }
    if (event is KeyRepeatEvent) {
      _inputService.handleKeyRepeat(widget.pageId, event);
      return KeyEventResult.handled;
    }
